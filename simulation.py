...
for i in range(100_000):
    ...
    angle_front, angle_back, total_speed_front, total_speed_back = control_vehicle(x_pos, y_pos, x_speed, y_speed, tilt, tilt_speed, current_angle_front, current_angle_back)
